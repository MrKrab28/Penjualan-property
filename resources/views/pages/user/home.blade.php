            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7 order-md-last d-flex align-items-stretch">
                        ...
                        <div class="img w-100 img-2 mr-md-2" style="background-image: url({{ asset('assets/user/images/GERBANG.jpg') }});"></div>
                        <div class="img w-100 img-2 mr-md-2" style="background-image: url({{ asset('assets/user/images/GERBANG1.jpg') }});"></div>
                        <div class="img w-100 img-2 mr-md-2" style="background-image: url({{ asset('assets/user/images/GERBANG.jpg') }});"></div>
                        <div class="img w-100 img-2 mr-md-2" style="background-image: url({{ asset('assets/user/images/GERBANG1.jpg') }});"></div>
